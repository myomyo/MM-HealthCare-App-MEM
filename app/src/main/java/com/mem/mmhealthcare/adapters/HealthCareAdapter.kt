...
class HealthCareAdapter(context: Context, private val mItemDelegate: HealthCareItemDelegate) : BaseRecyclerAdapter<HealthCareViewHolder, HealthCareInfoVO>(context) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HealthCareViewHolder {
        ...
        return HealthCareViewHolder(itemView,mItemDelegate)
    }
